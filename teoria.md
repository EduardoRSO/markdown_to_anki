...
## Interpretação matemática de situações-problema contextualizadas
...
## Potenciação e radiciação com números racionais nas suas representações fracionária ou decimal
...
## Resolução de problemas envolvendo mais de uma operação
...
### Raciocínio proporcional aplicado a contextos práticos
...
### Aplicações práticas das grandes e medidas no cotidiano urbano - Quantidade, tempo, comprimento, superfície, capacidade e massa

## Relações entre grandezas - Tabela ou gráfico

### Leitura e análise de gráficos e tabelas com dados do cotidiano
...
### Forma, área e perímetro

### Volume

## Estimativas e aproximações númericas
...
## Organização e comparação de dados númericos

## Sequências: Identificação de padrões númericos e lógicos
